...
public class BTUON_SprayAndWaitRouter extends ActiveRouter {
    ...
    public BTUON_SprayAndWaitRouter(Settings s) {
        super(s);
     ...
     */
    protected BTUON_SprayAndWaitRouter(BTUON_SprayAndWaitRouter r) {
        super(r);
    ...
    public Message messageTransferred(String id, DTNHost from) {
        ...
        BTUON_SprayAndWaitRouter othRouter = (BTUON_SprayAndWaitRouter) from.getRouter();
    ...
    protected List<Message> getMessagesWithCopiesLeft() {
        ...
        // sort copies left (priority by nrofcopies)
        // descending
            list.sort((Message m1, Message m2) -> {
            int copies1 = (Integer) m1.getProperty(MSG_COUNT_PROPERTY);
            int copies2 = (Integer) m2.getProperty(MSG_COUNT_PROPERTY);
            return Integer.compare(copies2, copies1);
        });
    ...
    @Override
    public BTUON_SprayAndWaitRouter replicate() {
        return new BTUON_SprayAndWaitRouter(this);
    }
